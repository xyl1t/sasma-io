...
function addPlayerComponents(playerId) {
  ...
  CircleCollider.radius[playerId] = 22;
...
function generateBuildings(world){

 //large Barrels
  let bId = addEntity(world);
  addComponent(world, Position, bId);
  Position.x[bId] = 100;
  Position.y[bId] = -1250;
  addComponent(world, Sprite, bId);
  Sprite.texture[bId] = world.assetIdMap.barrelsLarge;

  bId = addEntity(world);
  addComponent(world, Position, bId);
  Position.x[bId] = 800;
  Position.y[bId] = 150;
  addComponent(world, Rotation, bId);
  Rotation.angle[bId] = 0.5;
  addComponent(world, Sprite, bId);
  Sprite.texture[bId] = world.assetIdMap.barrelsLarge;
  ...
  Position.y[bId] = 1350;
  addComponent(world, Sprite, bId);
  Sprite.texture[bId] = world.assetIdMap.barrelsSmall;
  ...
  Position.y[bId] = -500;
  addComponent(world, Sprite, bId);
  Sprite.texture[bId] = world.assetIdMap.roadBarrierLarge;
  ...
  Position.y[bId] = -800;
  addComponent(world, Sprite, bId);
  Sprite.texture[bId] = world.assetIdMap.sandbags;
