...
function checkIfEntityVisible(id, meId){
  ...
  if (Position.x[id] > Position.x[meId] + Player.viewDistanceWidth[meId] / 2){
    entityIsVisible = false;
  } else if (Position.y[id] > Position.y[meId] + Player.viewDistanceHeight[meId] / 2){
    entityIsVisible = false;
  } else if (Position.x[id] < Position.x[meId] - Player.viewDistanceWidth[meId] / 2){
    entityIsVisible = false;
  } else if (Position.y[id] < Position.y[meId] - Player.viewDistanceHeight[meId] / 2){
    entityIsVisible = false;
  }
