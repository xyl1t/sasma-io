  ...
  for (let eId of effects) {
    if (PickupEffect.effectDuration[eId] > 0) {
      ...
      switch (PickupEffect.type[eId]) {
        case world.assetIdMap.pickup_movement:
          Body.power[eId] = PickupEffect.effectValue[eId];
          break;

        case world.assetIdMap.pickup_reload:
          Gun.rateOfFire[eId] = PickupEffect.effectValue[eId];
          break;

        case world.assetIdMap.pickup_damage:
          Gun.damage[eId] = PickupEffect.effectValue[eId];
          break;
      ...
      switch (PickupEffect.type[eId]) {
        case world.assetIdMap.pickup_movement:
          Body.power[eId] = PickupEffect.oldValue[eId];
          break;

        case world.assetIdMap.pickup_reload:
          Gun.rateOfFire[eId] = PickupEffect.oldValue[eId];
          break;

        case world.assetIdMap.pickup_damage:
          Gun.damage[eId] = PickupEffect.oldValue[eId];
          break;
